...
- **Keep monorepo projects as subtrees, not submodules** — publish a project directory inside this monorepo to GitHub without `make-repo` converting it into a git submodule afterward. → [howto/avoid-submodule-conversion.md](howto/avoid-submodule-conversion.md)
